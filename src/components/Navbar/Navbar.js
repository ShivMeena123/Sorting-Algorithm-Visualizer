...
const Navbar = ({handleStop, handleLength, handleSpeed, handleAlgo, generateRandomArray, handleSort, sorting, completed, len, speed, algo }) =>{
        ...
        <nav>
            ...
            <div className='toolbox'>
                ...
                <div>
                    ...
                    {sorting &&  <button onClick={handleStop} >Stop</button>}
                </div>
            </div>
        </nav>
    )
